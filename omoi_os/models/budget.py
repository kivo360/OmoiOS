...
class Budget(Base):
    ...
    limit_amount: Mapped[float] = mapped_column(Float, nullable=False)  # Maximum allowed spend
    spent_amount: Mapped[float] = mapped_column(Float, nullable=False, default=0.0)  # Current spend
    remaining_amount: Mapped[float] = mapped_column(Float, nullable=False)  # Calculated: limit - spent
    ...
    # Alert configuration
    alert_threshold: Mapped[float] = mapped_column(Float, nullable=False, default=0.8)  # Trigger alert at 80%
    alert_triggered: Mapped[int] = mapped_column(Integer, nullable=False, default=0)  # Boolean flag
    ...
    def to_dict(self) -> dict:
        ...
        return {
            ...
            "utilization_percent": (self.spent_amount / self.limit_amount * 100) if self.limit_amount > 0 else 0,
