      ...
      >
        ...
        >
          ...
          >
            ...
            <CodeLine
              lineNum={2}
              code="import { WebhookEvent } from './types';"
            />
            <CodeLine lineNum={3} code="" />
            <CodeLine
              lineNum={4}
              code="export async function handleWebhook("
              highlight
            />
            ...
            <CodeLine
              lineNum={8}
              code="    case 'checkout.session.completed':"
              added
            />
            <CodeLine
              lineNum={9}
              code="      await updateOrderStatus(event);"
              added
            />
            <CodeLine
              lineNum={10}
              code="      await sendConfirmationEmail(event);"
              added
            />
