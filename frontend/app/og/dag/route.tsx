    ...
    >
      ...
      <div
        style={{
          ...
          bottom: 0,
          backgroundImage:
            "radial-gradient(rgba(255,200,50,0.03) 1px, transparent 1px)",
          ...
          >
            <div
              style={{
                ...
                borderRadius: "16px",
                background:
                  "linear-gradient(135deg, rgba(255,215,0,0.2) 0%, rgba(255,138,42,0.1) 100%)",
          ...
          >
            <div
              style={{
                ...
                height: "60px",
                background:
                  "linear-gradient(135deg, rgba(255,200,50,0.3) 0%, rgba(255,138,42,0.2) 100%)",
