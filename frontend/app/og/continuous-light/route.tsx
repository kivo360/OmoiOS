        ...
        >
          ...
          >
            ...
            >
              {/* Circular arrow path */}
              <defs>
                <linearGradient id="arrowGradLight" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="408,250 400,270 415,265" fill="#B8860B" opacity="0.8" />
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="350,408 330,400 335,415" fill="#B8860B" opacity="0.8" />
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="170,400 190,408 185,393" fill="#B8860B" opacity="0.8" />
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="112,250 120,270 105,265" fill="#B8860B" opacity="0.8" />
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="190,112 170,120 175,105" fill="#B8860B" opacity="0.8" />
              ...
              <path
                ...
                strokeDasharray="8 4"
              />
              <polygon points="350,120 330,112 335,127" fill="#B8860B" opacity="0.8" />
            </svg>
            ...
            >
              ...
              >
                ...
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                  <circle cx="11" cy="11" r="8" stroke="#FFF9F0" strokeWidth="2.5" />
                  <line x1="21" y1="21" x2="16.65" y2="16.65" stroke="#FFF9F0" strokeWidth="2.5" strokeLinecap="round" />
                </svg>
              </div>
              <span
                style={{
            ...
            >
              ...
              >
                {/* Wrench/tool icon */}
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                  <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z" stroke="#FFF9F0" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                </svg>
              </div>
              <span
                style={{
            ...
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                <path d="M23 4v6h-6M1 20v-6h6" stroke="#B8860B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" stroke="#B8860B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span
                style={{
                  fontSize: "12px",
