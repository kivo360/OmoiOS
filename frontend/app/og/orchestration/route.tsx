          ...
          >
            ...
            >
              <defs>
                ...
                <linearGradient id="lineGrad2" x1="50%" y1="50%" x2="100%" y2="50%">
                  <stop offset="0%" stopColor="#FFD04A" stopOpacity="0.8" />
                  <stop offset="100%" stopColor="#F0A500" stopOpacity="0.3" />
                </linearGradient>
                <linearGradient id="lineGrad3" x1="50%" y1="50%" x2="100%" y2="100%">
                  <stop offset="0%" stopColor="#FFD04A" stopOpacity="0.8" />
              ...
              <path d="M 260 250 L 380 250 L 480 100" stroke="url(#lineGrad1)" strokeWidth="2" fill="none" />
              {/* Decision diamond on path */}
              <polygon points="380,250 390,240 380,230 370,240" fill="#FFD04A" opacity="0.6" />

              {/* To Test Agent (right) */}
              <path d="M 260 250 L 380 250 L 520 250" stroke="url(#lineGrad2)" strokeWidth="2" fill="none" />

              {/* To Review Agent (bottom-right) */}
              <path d="M 260 250 L 380 250 L 480 400" stroke="url(#lineGrad3)" strokeWidth="2" fill="none" />
              {/* Decision diamond on path */}
              <polygon points="380,250 390,260 380,270 370,260" fill="#F0A500" opacity="0.6" />

              {/* To Deploy Agent (bottom) */}
              <path d="M 260 250 L 260 340 L 260 430" stroke="url(#lineGrad4)" strokeWidth="2" fill="none" />
              {/* Decision diamond on path */}
              <polygon points="260,340 270,350 260,360 250,350" fill="#E8A317" opacity="0.6" />

              {/* Incoming task lines */}
              <path d="M 50 100 L 180 250" stroke="rgba(255,200,50,0.3)" strokeWidth="1.5" strokeDasharray="4 4" fill="none" />
              <path d="M 50 250 L 180 250" stroke="rgba(255,200,50,0.3)" strokeWidth="1.5" strokeDasharray="4 4" fill="none" />
              <path d="M 50 400 L 180 250" stroke="rgba(255,200,50,0.3)" strokeWidth="1.5" strokeDasharray="4 4" fill="none" />
            </svg>
            ...
            >
              ...
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <rect x="3" y="3" width="18" height="18" rx="2" stroke="#FFD04A" strokeWidth="1.5" fill="none" opacity="0.7" />
                </svg>
              </div>
            </div>
            ...
            >
              ...
              >
                ...
                <svg width="50" height="50" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2a4 4 0 0 1 4 4v1a3 3 0 0 1 3 3v1a3 3 0 0 1-1 2.24V16a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4v-2.76A3 3 0 0 1 5 11v-1a3 3 0 0 1 3-3V6a4 4 0 0 1 4-4z" stroke="#1a150d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
                  <circle cx="9" cy="10" r="1" fill="#1a150d" />
                  <circle cx="15" cy="10" r="1" fill="#1a150d" />
                  <path d="M9 14h6" stroke="#1a150d" strokeWidth="2" strokeLinecap="round" />
                </svg>
              </div>
              <span
                style={{
            ...
            >
              ...
              >
                {/* Eye icon */}
                <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" stroke="#1a150d" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none" />
            ...
            >
              <span style={{ fontSize: "10px", fontFamily: "Montserrat", color: "rgba(255,200,50,0.8)" }}>P1</span>
            </div>
            ...
            >
              <span style={{ fontSize: "10px", fontFamily: "Montserrat", color: "rgba(255,200,50,0.8)" }}>P2</span>
            </div>
          </div>
        </div>
      </div>
