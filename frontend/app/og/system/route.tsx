...
function topLeft({ x, y, w, h }: { x: number; y: number; w: number; h: number }) {
  return {
    left: `${x - w / 2}px`,
    top: `${y - h / 2}px`,
    width: `${w}px`,
    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(145deg, #2d2618 0%, #1a150d 52%, #0f0c08 100%)",
          position: "relative",
          ...
          >
            ...
            <div
              style={{
                ...
                ...topLeft(n.spec),
                borderRadius: "18px",
                background: "linear-gradient(135deg, rgba(255, 208, 74, 0.16) 0%, rgba(255, 138, 42, 0.08) 100%)",
            ...
            >
              <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  fill="none"
                />
                <polyline points="14,2 14,8 20,8" stroke={gold} strokeWidth="2" fill="none" />
                <line x1="16" y1="13" x2="8" y2="13" stroke={gold} strokeWidth="2" />
                <line x1="16" y1="17" x2="8" y2="17" stroke={gold} strokeWidth="2" />
              </svg>
            </div>
            <div
              style={{
            ...
            <div
              style={{
                ...
                background: "linear-gradient(135deg, #FFE78A 0%, #FFD04A 52%, #FF8A2A 100%)",
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                boxShadow:
            ...
            >
              <svg width="50" height="50" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M9 14h6" stroke={ink} strokeWidth="2" strokeLinecap="round" />
              </svg>
            </div>
            <div
              style={{
            ...
            >
              <span style={{ fontSize: "11px", fontFamily: "Montserrat", fontWeight: 300, color: muted }}>Code</span>
            </div>
            ...
            >
              <span style={{ fontSize: "11px", fontFamily: "Montserrat", fontWeight: 300, color: muted }}>Test</span>
            </div>
            ...
            >
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  fill="none"
                />
                <circle cx="12" cy="12" r="3" stroke={ink} strokeWidth="2" fill="none" />
              </svg>
            </div>
            <div
              style={{
            ...
            >
              <span style={{ fontSize: "11px", fontFamily: "Montserrat", fontWeight: 300, color: muted }}>
                Review
              </span>
            </div>
            ...
            <div
              style={{
                ...
                background: "linear-gradient(135deg, rgba(255, 208, 74, 0.20) 0%, rgba(255, 138, 42, 0.12) 100%)",
            ...
            >
              <div style={{ transform: "rotate(-45deg)", display: "flex" }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="none">
                  <path d="M12 2L2 7l10 5 10-5-10-5z" stroke={gold} strokeWidth="2" fill="none" />
                  <path d="M2 17l10 5 10-5" stroke={gold} strokeWidth="2" fill="none" />
                  <path d="M2 12l10 5 10-5" stroke={gold} strokeWidth="2" fill="none" />
                </svg>
              </div>
            </div>
            <div
            ...
            >
              <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  strokeLinejoin="round"
                />
                <path d="M2 12H22" stroke={ink} strokeWidth="2.5" strokeLinecap="round" />
                <path
                  d="M8 6L2 12L8 18"
                  stroke={ink}
                  strokeWidth="2.5"
