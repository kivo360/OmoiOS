      ...
      <div className="space-y-6">
          ...
          <CardContent>
            ...
            {!twoFactorEnabled && (
              <div className="mt-4 rounded-lg bg-muted p-4">
                <p className="text-sm text-muted-foreground">
                  Enable two-factor authentication to require a verification
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              How your account access is managed
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Your sessions are managed using secure JSON Web Tokens
                    (JWT). Access tokens expire after 15 minutes, and refresh
            ...
            <div className="flex items-center justify-between rounded-lg border p-4">
              ...
              <Button variant="outline" asChild>
                <Link href="/settings/api-keys">Manage Keys</Link>
              </Button>
            </div>
