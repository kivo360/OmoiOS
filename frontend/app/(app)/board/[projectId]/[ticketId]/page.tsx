...
const TaskCard = memo(function TaskCard({
  ...
  const config =
    statusConfig[taskStatus as keyof typeof statusConfig] ||
  ...
  const cardContent = (
    <CardContent className="p-4">
      <div className="flex items-center gap-4">
        ...
        {hasSandbox && <ArrowRight className="h-4 w-4 text-muted-foreground" />}
      </div>
    </CardContent>
  );
  ...
  return hasSandbox ? (
    ...
    <Card className="opacity-75">{cardContent}</Card>
  );
});
...
export default function TicketDetailPage({ params }: TicketDetailPageProps) {
  ...
  const StatusIcon =
    statusConfig[ticketStatus as keyof typeof statusConfig]?.icon || Clock;
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3 text-sm">
                <Badge
                  variant={
                    (statusConfig[ticketStatus as keyof typeof statusConfig]
                      ?.color as any) || "secondary"
                  }
                >
                  <StatusIcon
          ...
          <ScrollArea className="flex-1 relative">
                ...
                <Card>
                  <CardContent className="p-6 text-center text-muted-foreground">
                    ...
                    <p className="text-sm mt-2">
                      Agent discussions and user feedback will appear here.
                    </p>
                  </CardContent>
                </Card>
              ...
              <div className="max-w-3xl space-y-4">
                <div className="flex items-center justify-between">
                  <p className="text-sm text-muted-foreground">
                    {ticketTasks.filter((t) => t.status === "completed").length}{" "}
                    of {ticketTasks.length} tasks completed
                  </p>
                  <Button size="sm">
                ...
                {ticketTasks.length === 0 ? (
                  <Card>
                    <CardContent className="p-6 text-center text-muted-foreground">
                      ...
                      <p>No tasks yet</p>
                      <p className="text-sm mt-2">
                        Tasks will be created as agents work on this ticket.
                      </p>
                    </CardContent>
                  </Card>
                ) : (
              ...
              <div className="max-w-3xl space-y-4">
                <Card>
                  <CardContent className="p-6 text-center text-muted-foreground">
                    ...
                    <p className="text-sm mt-2">
                      Commits linked to this ticket will appear here once
                      tracking is enabled.
                    </p>
                  </CardContent>
                </Card>
            ...
            <TabsContent value="reasoning" className="m-0 p-6">
              <div className="max-w-3xl space-y-4">
                ...
                {/* Context from ticket */}
                {ticketContext?.full_context &&
                Object.keys(ticketContext.full_context).length > 0 ? (
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Aggregated context from agent work
                      </CardDescription>
                    </CardHeader>
                    <CardContent>
                  ...
                  <Card>
                    <CardContent className="p-6 text-center text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">
                        Agent decisions and discoveries will appear here as they
                        work on this ticket.
                      </p>
                    </CardContent>
                  </Card>
              ...
              <div className="space-y-3">
                <div>
                  <div className="flex items-center justify-between text-sm mb-1">
                    ...
                    <span>
                      {
                        ticketTasks.filter((t) => t.status === "completed")
                          .length
                      }
                      /{ticketTasks.length || 0}
                    </span>
