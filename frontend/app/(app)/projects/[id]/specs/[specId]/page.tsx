...
export default function SpecWorkspacePage({ params }: SpecPageProps) {
  ...
  const [linkedTicketIds, setLinkedTicketIds] = useState<Set<string>>(
    new Set(),
  );
  ...
  // - 1.5s when executing (fast updates for real-time progress)
  // - 10s otherwise (catch status changes without excessive requests)
  const {
    data: spec,
    ...
    staleTime: 2_000, // Consider data stale after 2s for this page
  });
  ...
  const { data: executionStatus } = useExecutionStatus(specId, {
    enabled: !!specId,
    refetchInterval: isExecuting ? 1500 : 10000,
  });
  ...
  useEffect(() => {
    ...
    if (
      ...
      const fromPhaseLabel =
        phaseLabels[previousPhaseRef.current] || previousPhaseRef.current;
  ...
  const handleAddRequirement = async () => {
    if (
      ...
      !newRequirement.condition ||
      !newRequirement.action
    ) {
  ...
  const handleExecuteTasks = async () => {
    try {
      ...
      if (result.success) {
        toast.success(
          `Execution started! ${result.tasks_created} task(s) queued.`,
        );
      } else {
  ...
  const handleArchiveSpec = async () => {
    if (
      !confirm(
        "Are you sure you want to archive this spec? This action cannot be undone.",
      )
    ) {
      return;
    }
      ...
      <div className="flex h-[calc(100vh-3.5rem)] items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            The specification may have been deleted.
          </p>
          <Button asChild>
          ...
          <div className="flex items-start justify-between">
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-3">
                ...
                <Badge
                  variant={
                    specData.status === "executing" ? "default" : "secondary"
                  }
                >
                  {specData.phase}
                </Badge>
          ...
          <ScrollArea className="flex-1">
                  ...
                  >
                    ...
                    <DialogContent className="sm:max-w-[500px]">
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Create a new EARS-style requirement with condition and
                          action.
                        </DialogDescription>
                      </DialogHeader>
                ...
                <div className="space-y-4">
                  {requirements.length === 0 ? (
                    <Card>
                      <CardContent className="p-6 text-center text-muted-foreground">
                        ...
                        <p className="text-sm mt-2">
                          Add your first requirement to start defining what the
                          system should do.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    requirements.map((req) => {
                      ...
                      const completedCriteria = req.criteria.filter(
                        (c: any) => c.completed,
                      ).length;
                      const config =
                                ...
                                <div className="flex items-start gap-4">
                                  ...
                                  <div className="flex-1 space-y-1">
                                    ...
                                    <div className="flex items-center gap-4 text-sm text-muted-foreground">
                                      <span>
                                        {completedCriteria}/
                                        {req.criteria.length} criteria met
                                      </span>
                                      {req.linked_design && (
                                      ...
                                      >
                                        ...
                                        <DialogContent>
                                          <DialogHeader>
                                            ...
                                            <DialogDescription>
                                              Add a testable acceptance
                                              criterion for this requirement.
                                            </DialogDescription>
                                          </DialogHeader>
                                          <div className="grid gap-4 py-4">
                                            <div className="grid gap-2">
                                              <Label htmlFor="criterion-text">
                                                Criterion
                                              </Label>
                                              <Textarea
                                                id="criterion-text"
                ...
                {!design ? (
                  <Card>
                    <CardContent className="p-6 text-center text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">
                        Create architecture diagrams, data models, and API
                        specifications.
                      </p>
                    </CardContent>
                  </Card>
                      ...
                      <Card>
                        ...
                        <CardContent>
                          {design.architecture ? (
                            ...
                            <p className="text-sm text-muted-foreground">
                              No architecture diagram defined
                            </p>
                          )}
                        </CardContent>
                      </Card>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                          <div className="grid gap-2">
                            ...
                            <Select
                              value={newTask.phase}
                              onValueChange={(value) =>
                                setNewTask({ ...newTask, phase: value })
                              }
                            >
                              <SelectTrigger>
                                <SelectValue />
                ...
                {tasks.length === 0 ? (
                  <Card>
                    <CardContent className="p-6 text-center text-muted-foreground">
                      ...
                      <p className="text-sm mt-2">
                        Break down the implementation into discrete tasks with
                        dependencies.
                      </p>
                    </CardContent>
                  </Card>
                      ...
                      <table className="w-full">
                        ...
                        <tbody>
                          {tasks.map((task) => {
                            ...
                            const priority =
                              priorityConfig[
                                task.priority?.toLowerCase() as keyof typeof priorityConfig
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="grid gap-2">
                          ...
                          <Select
                            ...
                            onValueChange={(value) =>
                              setEditTask({ ...editTask, phase: value })
                            }
                          >
                            <SelectTrigger>
                              <SelectValue />
            ...
            <TabsContent value="execution" className="m-0 p-6">
              <div className="space-y-6">
                    ...
                    <Card>
                      <CardContent className="p-4">
                        <div className="space-y-2">
                          ...
                          <p className="text-2xl font-bold">
                            {criteriaStatus?.completion_percentage?.toFixed(
                              0,
                            ) ??
                          ...
                          {criteriaStatus && (
                            <p className="text-xs text-muted-foreground">
                              {criteriaStatus.completed_criteria}/
                              {criteriaStatus.total_criteria} criteria
                            </p>
                          )}
                        </div>
                      </CardContent>
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-2xl font-bold font-mono">
                            <span className="text-green-600">
                              +{execution?.lines_added ?? 0}
                            </span>
                            {" / "}
                            <span className="text-red-600">
                              -{execution?.lines_removed ?? 0}
                            </span>
                          </p>
                        </div>
                      </CardContent>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="grid gap-3 md:grid-cols-4">
                        {Object.entries(executionStatus.status_counts).map(
                          ([status, count]) => {
                            const statusInfo =
                              statusConfig[
                ...
                {criteriaStatus &&
                  criteriaStatus.by_requirement &&
                  Object.keys(criteriaStatus.by_requirement).length > 0 && (
                    <Card>
                      <CardHeader>
                        <CardTitle className="text-base">
                          Acceptance Criteria
                        ...
                        <CardDescription>
                          {criteriaStatus.completed_criteria}/
                          {criteriaStatus.total_criteria} criteria validated
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <div className="space-y-4">
                          {Object.entries(criteriaStatus.by_requirement).map(
                            ([reqId, reqData]) => (
                              <div key={reqId} className="space-y-2">
                                ...
                                <Progress
                                  value={
                                    (reqData.completed / reqData.total) * 100
                                  }
                                  className="h-1.5"
                                />
                                <div className="space-y-1">
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <p className="text-sm font-medium text-green-600">
                              Pull Request #{spec.pull_request_number}
                            </p>
            ...
            <div>
              ...
              <div className="space-y-2.5 text-sm">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xs text-muted-foreground">
                    {formatTimeAgo(specData.updatedAt)}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium tabular-nums">
                    {specData.testCoverage}%
                  </span>
                </div>
                <Progress value={specData.testCoverage} className="h-1.5" />
                {execution && (
                  <p className="text-xs text-muted-foreground">
                    {execution.tests_passing}/{execution.tests_total} tests
                    passing
                  </p>
                )}
              </div>
        ...
        <DialogContent className="sm:max-w-[600px]">
            ...
            {projectTickets?.tickets && projectTickets.tickets.length > 0 ? (
              ...
              <div className="text-center py-8">
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Create tickets from the command page or board to link them
                  here.
                </p>
              </div>
            )}
          ...
          <DialogFooter>
            <div className="flex items-center justify-between w-full">
              <span className="text-sm text-muted-foreground">
                {linkedTicketIds.size} ticket
                {linkedTicketIds.size !== 1 ? "s" : ""} selected
              </span>
              <div className="flex gap-2">
                <Button
                  variant="outline"
                  onClick={() => setLinkTicketsOpen(false)}
                >
                  Cancel
                </Button>
                <Button onClick={handleSaveLinkedTickets}>Save Links</Button>
              </div>
            </div>
          </DialogFooter>
        </DialogContent>
                    ...
                    <div key={version.id} className="relative pl-8">
                      ...
                      <div className="bg-muted/30 rounded-lg p-3 border">
                        ...
                        {version.change_details &&
                          Object.keys(version.change_details).length > 0 && (
                            <div className="mt-2 pt-2 border-t border-border/50">
                              <p className="text-[10px] font-medium text-muted-foreground uppercase tracking-wider mb-1">
                                Changes
                              </p>
                              <div className="space-y-1">
                                {Object.entries(version.change_details).map(
                                  ([field, changes]) => (
