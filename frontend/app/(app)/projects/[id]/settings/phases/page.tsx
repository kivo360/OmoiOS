...
export default function PhaseSettingsPage({ params }: PhaseSettingsPageProps) {
  ...
  const handleSave = () => {
    toast.success(
      "Phase settings saved locally. Note: Custom phases are system-defined.",
    );
  };
        ...
        <div className="flex-1 space-y-6">
          ...
          <div className="flex items-start gap-3 rounded-lg border border-blue-200 bg-blue-50 p-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700">
                Phases are system-defined and provide a consistent workflow
                across all projects. Custom phase creation is planned for a
                future release.
              </p>
            </div>
          </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                System-defined phases that provide the standard workflow. These
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center justify-center gap-2 overflow-x-auto py-4">
                {PHASES.map(
                  (phase: PhaseConfig, index: number, arr: PhaseConfig[]) => (
