...
export async function connectRepository(
  ...
  return api.post<ConnectRepositoryResponse>(
    `/api/v1/projects/${projectId}/github/connect`,
    data,
  );
}
...
export async function syncRepository(
  ...
  return api.post<SyncRepositoryResponse>(
...
export async function listRepos(
  ...
  return api.get<GitHubRepo[]>(
    `/api/v1/github/repos${query ? `?${query}` : ""}`,
  );
}
...
export async function createBranch(
  ...
  return api.post<BranchCreateResult>(
...
export async function createOrUpdateFile(
  ...
  return api.put<FileOperationResult>(
...
export async function getTree(
  ...
  return api.get<TreeItem[]>(
    `/api/v1/github/repos/${owner}/${repo}/tree?${searchParams}`,
  );
}
...
export async function createPullRequest(
  ...
  return api.post<PullRequestCreateResult>(
