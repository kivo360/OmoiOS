...
export async function updateRequirement(
  ...
  return apiRequest<Requirement>(
    `/api/v1/specs/${specId}/requirements/${reqId}`,
    {
      method: "PATCH",
      body: data,
    },
 ...
 */
export async function approveRequirements(
  specId: string,
): Promise<{ message: string }> {
  return apiRequest<{ message: string }>(
    `/api/v1/specs/${specId}/approve-requirements`,
    {
      method: "POST",
    },
  );
...
export async function approveDesign(
  ...
  return apiRequest<{ message: string }>(
    `/api/v1/specs/${specId}/approve-design`,
    {
      method: "POST",
    },
  );
...
export async function listSpecVersions(
  ...
  return apiRequest<SpecVersionListResponse>(
    `/api/v1/specs/${specId}/versions${params}`,
  );
}
...
export async function executeSpecTasks(
  ...
  return apiRequest<ExecuteTasksResponse>(
    `/api/v1/specs/${specId}/execute-tasks`,
    {
      method: "POST",
      body: request || {},
    },
...
export async function getExecutionStatus(
  ...
  return apiRequest<ExecutionStatusResponse>(
    `/api/v1/specs/${specId}/execution-status`,
  );
}
...
export async function getCriteriaStatus(
  ...
  return apiRequest<CriteriaStatusResponse>(
    `/api/v1/specs/${specId}/criteria-status`,
  );
}
...
export async function createSpecBranch(
  ...
  return apiRequest<CreateBranchResponse>(
    `/api/v1/specs/${specId}/create-branch`,
    {
      method: "POST",
    },
  );
...
export async function linkTicketsToSpec(
  ...
  return apiRequest<LinkTicketsResponse>(
    `/api/v1/specs/${specId}/link-tickets`,
    {
      method: "POST",
...
export async function getLinkedTickets(
  specId: string,
): Promise<LinkedTicketsResponse> {
  return apiRequest<LinkedTicketsResponse>(
    `/api/v1/specs/${specId}/linked-tickets`,
  );
}
...
export async function exportSpec(
  ...
  if (format === "markdown") {
    const response = await fetch(
      `/api/v1/specs/${specId}/export?format=markdown`,
      {
        credentials: "include",
      },
    );
