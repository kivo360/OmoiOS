...
function ComparisonView({
  ...
  const comparisons = [
    ...
    },
    {
      label: "Storage",
      current:
        current.storageGb === -1 ? "Unlimited" : `${current.storageGb}GB`,
    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose the plan that best fits your needs. You can upgrade,
            downgrade, or switch plans at any time.
          </DialogDescription>
        </DialogHeader>

        <Tabs
          value={activeTab}
          onValueChange={(v) => setActiveTab(v as "monthly" | "special")}
          className="mt-4"
        >
            ...
            <div className="p-4 rounded-lg bg-muted/50 text-sm text-muted-foreground">
              ...
              <ul className="space-y-1">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    <strong>Lifetime:</strong> One-time payment of $299, no
                    recurring charges. 50 workflows/month, 5 agents, and BYO API
                    keys.
                  </span>
                </li>
              </ul>
              <p className="mt-3 text-xs">
                ...
                <strong>BYO API Keys</strong> is included with Pro, Team, and
                Lifetime plans.
              </p>
            </div>
          </TabsContent>
