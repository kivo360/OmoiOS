    ...
    >
      ...
      {isCurrent && (
        <div className="absolute -top-3 left-1/2 -translate-x-1/2">
          <Badge
            variant="outline"
            className="bg-green-500/10 text-green-600 border-green-500/30 px-3"
          >
      ...
      <CardHeader className={cn(compact && "p-4 pb-2")}>
        ...
        <div className="mt-4">
          <span className="text-3xl font-bold">
            {config.price === 0 && tier !== "enterprise"
              ? "$0"
              : tier === "enterprise"
                ? "Custom"
                : `$${config.price}`}
      ...
      <CardContent
        className={cn("flex-1 flex flex-col", compact && "p-4 pt-0")}
      >
    ...
    >
      ...
      <CardContent>
        <p className="text-sm text-muted-foreground mb-4">
          Pay once, use forever. Perfect for indie developers and small teams
          ...
          <CardContent className="flex flex-col md:flex-row items-center justify-between gap-4 p-6">
            <div className="flex items-center gap-4 text-center md:text-left">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Unlimited everything, custom integrations, SLA, and dedicated
                  support.
                </p>
              </div>
            </div>
