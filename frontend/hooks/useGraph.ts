...
export const graphKeys = {
  ...
  project: (projectId: string) =>
    [...graphKeys.all, "project", projectId] as const,
  ticket: (ticketId: string) => [...graphKeys.all, "ticket", ticketId] as const,
  blockedTasks: (taskId: string) =>
    [...graphKeys.all, "blocked", taskId] as const,
  blockingTasks: (taskId: string) =>
    [...graphKeys.all, "blocking", taskId] as const,
};
