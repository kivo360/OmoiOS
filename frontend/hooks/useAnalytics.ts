...
export interface UseAnalyticsReturn {
   ...
   */
  track: <E extends AnalyticsEventName>(eventName: E, properties?: EventProperties<E>) => void
   ...
   */
  trackError: (error: Error | unknown, context?: { error_type?: string; api_endpoint?: string; http_status?: number }) => void
   ...
   */
  trackFeature: (featureName: string, action?: string, success?: boolean) => void
...
export function useAnalytics(): UseAnalyticsReturn {
  ...
  const wrappedTrack = useCallback(
    <E extends AnalyticsEventName>(eventName: E, properties?: EventProperties<E>) => {
  ...
  const wrappedTrackError = useCallback(
    (error: Error | unknown, context?: { error_type?: string; api_endpoint?: string; http_status?: number }) => {
  ...
  const wrappedSetUserProperties = useCallback(
