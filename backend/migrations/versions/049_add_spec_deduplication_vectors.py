...
def downgrade() -> None:
    ...
    op.drop_index('ix_spec_acceptance_criteria_req_content_hash', table_name='spec_acceptance_criteria')
    op.drop_column('spec_acceptance_criteria', 'content_hash')

    # Spec Requirements
    op.drop_index('ix_spec_requirements_spec_content_hash', table_name='spec_requirements')
