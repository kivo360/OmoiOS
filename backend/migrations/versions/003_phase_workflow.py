...
def upgrade() -> None:
    """Apply phase gate artifacts/results and context tracking."""
    op.add_column(
        "tickets",
        sa.Column(
            "context",
    ...
    op.create_index(
        "idx_phase_context_ticket",
        "phase_context",
        ["ticket_id"],
    )
    op.create_index(
        "idx_phase_context_ticket_phase",
        "phase_context",
        ["ticket_id", "phase_id"],
    )
...
def downgrade() -> None:
    """Drop phase gate/context tables and columns."""
    op.drop_index("idx_phase_context_ticket_phase", table_name="phase_context")
    op.drop_index("idx_phase_context_ticket", table_name="phase_context")
    op.drop_table("phase_context")
    ...
    op.drop_column("tickets", "context_summary")
    op.drop_column("tickets", "context")
