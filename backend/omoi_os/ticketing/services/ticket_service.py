...
class TicketService:
        ...
        *,
        ...
        ticket = Ticket(
            ...
            blocked_by_ticket_ids=(
                {"ids": blocked_by_ticket_ids or []} if blocked_by_ticket_ids else None
            ),
            created_at=utc_now(),
            updated_at=utc_now(),
            is_resolved=False,
        ...
        for k, v in updates.items():
            if k in allowed:
                ...
                setattr(
                    ticket,
                    k,
                    v if k not in {"tags", "blocked_by_ticket_ids"} else (v or None),
                )
    ...
    def change_status(
        ...
        *,
        ...
        if (
            new_status.lower() in {"done", "complete", "completed"}
