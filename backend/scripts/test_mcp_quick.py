...
def main():
    ...
    group.add_argument("--in-memory", action="store_true", help="In-memory test (no network)")
    group.add_argument("--live", action="store_true", help="Test against live server")
    group.add_argument("--http", action="store_true", help="HTTP transport test (in-process server)")
