...
async def test_fastmcp_server():
    ...
    async with Client(mcp_url, timeout=30.0) as client:
        ...
        try:
            ...
            print("   Note: This may fail if ticket_id doesn't exist")
        ...
        try:
            ...
            print("   ✅ Task created with discovery tracking")
            if hasattr(result, "data") and isinstance(result.data, dict):
                task_id = result.data.get("task_id")
            ...
            print("   Note: This may fail if ticket_id or source_task_id don't exist")
        ...
        try:
            ...
            print("   ✅ Retrieved workflow graph")
            if hasattr(result, "data") and isinstance(result.data, dict):
