...
**Created**: 2025-11-20
**Status**: Active
**Purpose**: Provides instructions and strategies for testing the intelligent monitoring system, including unit, integration, and smoke tests.
**Related**: docs/services/intelligent_monitoring.md, docs/architecture/monitoring_system_adr.md, docs/testing/testing_strategy_overview.md, .github/workflows/intelligent_monitoring_tests.yml
