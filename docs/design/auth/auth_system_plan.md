...
**Purpose**: Implementation plan detailing how to build the new self‑hosted authentication and authorization system.
**Related**: docs/requirements/auth/auth_system_requirements.md, docs/design/services/auth_service.md, docs/design/integration/oauth_integration.md, docs/implementation/auth_system_implementation_log.md, docs/architecture/adr_auth_decision.md
