...
**Created**: 2025-11-20
**Status**: Draft
**Purpose**: Technical design and API specification for the Workspace Isolation System that provides isolated, Git-backed workspaces for Hephaestus agents.
**Related**: docs/design/agents/agent_manager.md, docs/design/services/workspace_manager.md, docs/design/database_schema.md, docs/design/configuration_guide.md, docs/architecture/adr_workspace_isolation.md
