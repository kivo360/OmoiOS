...
**Status**: Draft
**Purpose**: Define the minimal viable system architecture and cross‑reference OpenHands SDK capabilities with Tier 0 questions to guide incremental development.
**Related**: ./openhands_insights_and_prioritization.md, ./implementation_questions.md, ./design/multi_agent_orchestration.md
