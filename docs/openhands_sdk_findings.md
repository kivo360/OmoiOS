...
**Created**: 2025-11-20
**Status**: Draft
**Purpose**: Summarize OpenHands SDK documentation findings and map them to open implementation questions
**Related**: docs/implementation_questions.md, docs/design/agents/openhands_sdk_overview.md, docs/architecture/agents/openhands_sdk_adr.md
