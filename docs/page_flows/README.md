...
- **[09c_phase_configuration.md](./09c_phase_configuration.md)** - Flows 28-32: Phase Configuration, Custom Phase Creation, Phase Gate Approval, Task Phase Management, Phase Metrics, Quality Metrics

### Cost & Resource Management

- **[11_cost_management.md](./11_cost_management.md)** - Flows 42-46: Cost Dashboard, Cost Records, Budget Management, Cost Forecasting
...
| 42     | Cost Dashboard                   | [11_cost_management.md](./11_cost_management.md)                 |
| 43     | Cost Records                     | [11_cost_management.md](./11_cost_management.md)                 |
| 44     | Budget Management                | [11_cost_management.md](./11_cost_management.md)                 |
| 45     | Budget Creation                  | [11_cost_management.md](./11_cost_management.md)                 |
| 46     | Cost Forecasting                 | [11_cost_management.md](./11_cost_management.md)                 |
| 47     | Memory Search                    | [12_agent_memory.md](./12_agent_memory.md)                       |
| 48     | Learned Patterns                 | [12_agent_memory.md](./12_agent_memory.md)                       |
...
|------|---------|-----------|
| 200 | OK | Successful GET, PUT, PATCH, or POST without creation |
...
```json
{
  "detail": "Ticket with ID 'xyz' not found",
  "code": "NOT_FOUND"
}
```
