...
**Created**: 2025-11-20
**Status**: Draft
**Purpose**: Define normative requirements for the Validation Agent System, covering state machine, data model, API, configuration, SLOs, security, memory, and diagnosis integration.
**Related**: docs/requirements/workflows/multi_agent_orchestration.md, docs/design/agents/validation_agent_design.md, docs/requirements/services/memory_system.md, docs/requirements/services/diagnosis_system.md
